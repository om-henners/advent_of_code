...
Trying to  teach the game to play itself.
"""
...
def mutate_grow_longer(individual: OpCodes) -> Tuple[OpCodes]:
    """
    Make the number of steps in the game increase
    """
    individual.append(random.choice([-1, 0, 1]))
    return individual,
...
def main():
    ...
    toolbox.register('moves', random.choices, [-1, 0, 1])
    ...
    toolbox.register("evaluate", partial(game_player, opcodes=opcodes))
