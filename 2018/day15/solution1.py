...
while Elf.members and Goblin.members:
    ...
    # if Elf.members:
    #     plt.scatter(
    #         [elf.location[1] for elf in Elf.members],
    #         [elf.location[0] for elf in Elf.members],
    #         marker = '^',
    #         color='black'
    #     )
    # if Goblin.members:
    #     plt.scatter(
    #         [goblin.location[1] for goblin in Goblin.members],
    #         [goblin.location[0] for goblin in Goblin.members],
    #         marker='s',
    #         color='green'
    #     )
    # plt.show()
